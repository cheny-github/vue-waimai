<template>
  ...
  @click="flag_showBriefModal=true" 
  v-if="info.supports"
  >
    <nav class="shop-nav"
    ...
    <div class="shop-header-discounts"
     @click.stop="flag_showPromitionModal = true "
    >
  ...
  <transition name="fade">
    ...
    v-show="flag_showBriefModal"
    @click.stop="flag_showBriefModal=false"
    >
      <div class="brief-modal-content"
         @click.stop="flag_showBriefModal=true"
       >
        <h2 class="content-title">
          <span class="content-tag">
            <span class="mini-tag">品牌</span>
  ...
  <transition name="fade">
    ...
    v-if="flag_showPromitionModal&& info.supports"
    @click.stop="flag_showPromitionModal =false"
    >
      <div class="activity-sheet-content" @click.stop="flag_showPromitionModal=true">
...
export default {
  ...
  data() {
    return {
      flag_showBriefModal:false,
      tagClass:['activity-red','activity-orange','activity-green'],
      flag_showPromitionModal:false
    }
  },
}
</script>
