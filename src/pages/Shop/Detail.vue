<template>
  <div class="shop-info" ref="shopInfoScrollWrapper">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <!-- activity-red activity-orange activity-green -->
          <div class="activity-item "
           v-for="(support, index) in info.supports" :key="index"
           :class="getActivityClass(support.type)"
           >
      ...
      <section class="section">
        ...
        <div class="pic-wrapper" ref="picListScollWrapper">
          <ul class="pic-list" >
...
export default {
  ...
  methods:{
    ...
    initScroll(){
      this.shopInfoScroll = new BScroll(this.$refs.shopInfoScrollWrapper ,{click:true});
      this.picListScoll = new BScroll(this.$refs.picListScollWrapper,{
        click:true,
        scrollX:true
      });
    },
    destroyScroll(){
      this.shopInfoScroll.destroy();
      this.picListScoll.destroy();
    },
  },
  watch:{
    info(){
